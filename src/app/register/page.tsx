    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">選擇你的身份開始</p>
          ...
          <div className="grid grid-cols-3 gap-2 mb-6">
            ...
            >
              ...
              <div className={`text-sm font-medium ${role === 'customer' ? 'text-purple-600' : 'text-gray-600'}`}>
                顧客
              </div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-1">🏪</div>
              <div className={`text-sm font-medium ${role === 'merchant' ? 'text-blue-600' : 'text-gray-600'}`}>
                商戶
              </div>
            </button>
            <button
            ...
            >
              <div className="text-2xl mb-1">🚚</div>
              <div className={`text-sm font-medium ${role === 'driver' ? 'text-green-600' : 'text-gray-600'}`}>
                司機
              </div>
            </button>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            已經有帳戶？{' '}
            <Link href={`/login/${role}`} className="text-purple-600 hover:underline font-medium">
              登入 →
            </Link>
          </p>
        </div>
