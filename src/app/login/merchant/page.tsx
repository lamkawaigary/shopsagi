...
export default function MerchantLoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (isSafari) {
        sessionStorage.setItem('loginRole', 'merchant');
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-6">
          <Link href="/" className="text-2xl font-bold text-blue-600">🏪 ShopSagi 商戶</Link>
        </div>

        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">商戶登入</h1>
          <p className="text-gray-600 mb-6">管理你嘅店鋪同訂單</p>
